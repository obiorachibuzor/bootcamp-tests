describe('Test my mostProfitableDepartmentFunction' , function(){
    it("it should return which departments are the 'most profitable' and 'which day of the week' is the most profitable " , function(){
        var salesData = [
